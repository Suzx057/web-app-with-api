...
import { getAllProduct } from "../../service/httpsService";

const Producttable = ({ onclickModal, onclickModalDel }) => {
  ...
  return (
    <>
            ...
            return (
              <>
                <tr className="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <td className="px-4 py-3">{data.product}</td>
      ...
      <nav aria-label="Page navigation example">
        <ul className="flex justify-center -space-x-px text-sm m-8">
          <li>
            <a
              href="#"
